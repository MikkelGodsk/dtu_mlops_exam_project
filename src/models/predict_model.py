...
def translate(
    ...
    checkpoint: Optional[str] = "models/epoch=1-step=3750.ckpt" #None,  # "models/epoch=1-step=3750.ckpt"
):
    ...
    if checkpoint is None:
        ...
        print(dict(model.state_dict()).keys())
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint", default="models/epoch=1-step=3750.ckpt", type=str, help="Path to checkpoint"
